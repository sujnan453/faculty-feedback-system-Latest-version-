...
if (document.getElementById('studentRegisterForm')) {
    document.getElementById('studentRegisterForm').addEventListener('submit', function (e) {
        ...
        try {
            ...
            const { fullName, email, rollNumber, department, password, confirmPassword } = formData;
            ...
            if (users.some(u => u.rollNumber === rollNumber.toUpperCase())) {
                showAlert('Roll number already registered! Please check your roll number.');
                return;
            }
...
if (document.getElementById('adminLoginForm')) {
    document.getElementById('adminLoginForm').addEventListener('submit', function (e) {
        ...
        try {
            const formData = extractFormData(this);
            const { email: emailOrUsername, password, remember } = formData;
